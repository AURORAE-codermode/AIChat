package com.zjgsu.aichat.service.impl;

import com.volcengine.ark.runtime.model.completion.chat.ChatMessage;
import com.volcengine.ark.runtime.model.completion.chat.ChatMessageRole;
import com.zjgsu.aichat.model.ChatRoom;
import com.zjgsu.aichat.service.AiManage;
...
public class ChatServiceImpl implements ChatService {
    ...
    public String dochat(Long roomId, String userPrompt) {
        ...
        //1、根据roomid，来查找历史记录，构建对话列表
        List<ChatMessage> messages = new ArrayList<>();
        final ChatMessage systemMessage = ChatMessage.builder().role(ChatMessageRole.SYSTEM).content(systemPrompt).build();
        final ChatMessage userMessage = ChatMessage.builder().role(ChatMessageRole.USER).content(userPrompt).build();

        //1.1如果是开始，我们要new一个map，开新roomid
